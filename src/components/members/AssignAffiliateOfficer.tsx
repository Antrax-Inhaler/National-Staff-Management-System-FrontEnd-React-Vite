...
import { fetchNoPositionAffiliateMembers } from "../../api/officers/fetchNoPositionsAffilateMembers";
import { assignNewOfficer, type positionForm } from "../../api/officers/assignNewOfficer";
...
export default function AssignAffiliateOfficer({
  ...
  const { data: members, isLoading } = useQuery<Member[]>({
    ...
    queryFn: () =>
      fetchNoPositionAffiliateMembers(session!.access_token, affiliateId),
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: (member: positionForm) =>
      assignNewOfficer(member, session!.access_token, affiliateId),
