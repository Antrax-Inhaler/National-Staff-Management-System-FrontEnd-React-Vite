...
import SubSidebar, {
  type SubSidebarContent
} from "@v1/layout/Sidebar/NewSubSidebar";
...
export default function ResearchDocuments() {
  ...
  const items: SubSidebarContent[] = [
      ...
      items: [
        {
          ...
          label: "Research Document Overview",
          icon: LayoutGrid,
    ...
    },
    {
      id: "national-section",
      type: "section",
      searchable: true, // Search input will appear here
      searchPlaceholder: "Search affiliates...", // Custom placeholder
    ...
    <div className="flex flex-col h-full bg-white rounded-lg shadow shadow-neutral-50">
      ...
      <main className="flex flex-1 w-full min-h-0 overflow-hidden">
            ...
            title={
              <div className="flex flex-col items-start p-4">
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Manage research documents and materials
                </p>
              </div>
            }
            items={items}
        ...
        <div className="flex-1 overflow-y-auto bg-gray-50">
          {outlet ? <Outlet /> : <NewOverview type="research" />}
        </div>
      </main>
    </div>
  );
