...
interface ImportStatisticsResponse {
  success: boolean;
  data: {
    import: {
      id: string;
...
export const csvImport = {
  ...
  async getImportStatus(importId: string): Promise<{ success: boolean; data: ImportDetail }> {
  ...
  async getUserImports(): Promise<{ success: boolean; data: { imports: ImportJob[]; total: number } }> {
  ...
  async clearImportData(importId: string): Promise<{ success: boolean; message: string }> {
